...
[_SYMS] =  LAYOUT_ortho_4x12( \
  _______, _______, _______, _______,  KC_TILD, _______, _______, KC_DQUO, KC_QUOT, _______, _______, _______, \
  _______, _______, _______, KC_LPRN, KC_RPRN, _______, _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, _______, \
  _______, _______, _______, KC_BSLS, KC_PIPE, _______, _______, KC_EQL,  KC_MINUS, KC_GRV, _______, _______, \
