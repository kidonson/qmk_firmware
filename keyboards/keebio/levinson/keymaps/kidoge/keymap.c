...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, FUNC,    NUMS,    KC_SPC,  KC_SPC,  SYMS,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_NUMS] = LAYOUT_ortho_4x12( \
  ...
  _______, KC_PERC, KC_CIRC, KC_AMPR,  KC_ASTR,  _______, _______, KC_5,    KC_5,    KC_6,    _______, _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case FUNC:
      if (record->event.pressed) {
        layer_on(_FUNC);
        //update_tri_layer(_LOWER, _SYMS, _GAMING);
      } else {
        layer_off(_FUNC);
        //update_tri_layer(_LOWER, _SYMS, _GAMING);
      }
