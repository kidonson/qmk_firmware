...
[_SYMS] =  LAYOUT_ortho_4x12( \
  _______, _______, _______, KC_GRV,  KC_TILD, _______, _______, KC_DQUO, KC_QUOT, _______, _______, _______, \
  _______, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, \
